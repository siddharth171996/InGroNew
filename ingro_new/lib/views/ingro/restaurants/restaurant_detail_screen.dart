...
import 'package:ingronew/models/restaurant_detail.dart';
import 'package:ingronew/utils/ui_helper.dart';
import 'package:ingronew/widgets/custom_divider_view.dart';
import 'package:ingronew/widgets/veg_badge_view.dart';
...
class RestaurantDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: Text('Raveena Super Market'),
          actions: <Widget>[
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Column(
                    children: <Widget>[
                      _buildOfferTile(
                          context, '30% off up to Rs75 | Use code INGRO2020'),
